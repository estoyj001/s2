...
-- select country_name from countries as country
...
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES
-- (19,'Stock Manager',5500.00,8500.00);
-- select employee_id,first_name,last_name from employees where job_id = (select job_id from jobs where job_title ='Shipping Clerk')
-- select department_name from dept where department_id=8
...
-- insert into employees (employee_id,first_name,last_name,department_id) values(420,'Paul','Newton',11)
